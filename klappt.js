...
(() => {
  ...
  async function loadPackage(metadata) {
    ...
    var PACKAGE_NAME = "Release/klappt.data";
    ...
    async function runWithFS(Module) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_Release/klappt.data");
      }
      Module["addRunDependency"]("datafile_Release/klappt.data");
  ...
  loadPackage({
    "files": [ {
      "filename": "/Font-Awesome-7-Free-Solid-900.otf",
      "start": 0,
      "end": 414664
    }, {
      "filename": "/Inter-VariableFont.ttf",
      "start": 414664,
      "end": 1162732
    }, {
      ...
      "filename": "/ReadexPro-Regular.ttf",
      "start": 1714460,
      "end": 1841808
    }, {
      "filename": "/cacert.pem",
    ...
    "remote_package_size": 2028254
  });
})();

// end include: /tmp/tmp2vrdj53x.js
...
function ___syscall_ftruncate64(fd, length) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(6, 0, 1, fd, length);
...
function _emscripten_get_fullscreen_status(fullscreenStatus) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(26, 0, 1, fullscreenStatus);
  if (!JSEvents.fullscreenEnabled()) return -1;
...
function _emscripten_get_gamepad_status(index, gamepadState) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(27, 0, 1, index, gamepadState);
...
function _emscripten_request_fullscreen_strategy(target, deferUntilInEventHandler, fullscreenStrategy) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(30, 0, 1, target, deferUntilInEventHandler, fullscreenStrategy);
  var strategy = {
...
function _emscripten_request_pointerlock(target, deferUntilInEventHandler) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(31, 0, 1, target, deferUntilInEventHandler);
  target = findEventTarget(target);
  if (!target) return -4;
  if (!target.requestPointerLock) {
    return -1;
...
function _emscripten_set_beforeunload_callback_on_thread(userData, callbackfunc, targetThread) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(33, 0, 1, userData, callbackfunc, targetThread);
...
var fillDeviceMotionEventData = (eventStruct, e, target) => {
  ...
  ag = ag || {};
  rr = rr || {};
  (growMemViews(), HEAP32)[(((eventStruct) + (72)) >> 2)] = supportedFields;
...
function _fd_pread(fd, iov, iovcnt, offset, pnum) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(53, 0, 1, fd, iov, iovcnt, offset, pnum);
  offset = bigintToI53Checked(offset);
  try {
...
function _fd_pwrite(fd, iov, iovcnt, offset, pnum) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(54, 0, 1, fd, iov, iovcnt, offset, pnum);
  offset = bigintToI53Checked(offset);
  try {
    if (isNaN(offset)) return 61;
    var stream = SYSCALLS.getStreamFromFD(fd);
...
var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_fcntl64, ___syscall_fdatasync, ___syscall_fstat64, ___syscall_ftruncate64, ___syscall_getdents64, ___syscall_ioctl, ___syscall_lstat64, ___syscall_mkdirat, ___syscall_newfstatat, ___syscall_openat, ___syscall_renameat, ___syscall_rmdir, ___syscall_stat64, ___syscall_unlinkat, ___syscall_utimensat, __mmap_js, __munmap_js, _emscripten_exit_fullscreen, getCanvasSizeMainThread, setCanvasElementSizeMainThread, _emscripten_exit_pointerlock, _emscripten_get_device_pixel_ratio, _emscripten_get_element_css_size, _emscripten_get_fullscreen_status, _emscripten_get_gamepad_status, _emscripten_get_num_gamepads, _emscripten_get_screen_size, _emscripten_request_fullscreen_strategy, _emscripten_request_pointerlock, _emscripten_sample_gamepad_data, _emscripten_set_beforeunload_callback_on_thread, _emscripten_set_blur_callback_on_thread, _emscripten_set_devicemotion_callback_on_thread, _emscripten_set_element_css_size, _emscripten_set_focus_callback_on_thread, _emscripten_set_fullscreenchange_callback_on_thread, _emscripten_set_gamepadconnected_callback_on_thread, _emscripten_set_gamepaddisconnected_callback_on_thread, _emscripten_set_keydown_callback_on_thread, _emscripten_set_keypress_callback_on_thread, _emscripten_set_keyup_callback_on_thread, _emscripten_set_orientationchange_callback_on_thread, _emscripten_set_pointerlockchange_callback_on_thread, _emscripten_set_resize_callback_on_thread, _emscripten_set_visibilitychange_callback_on_thread, _emscripten_set_wheel_callback_on_thread, _emscripten_set_window_title, _environ_get, _environ_sizes_get, _fd_close, _fd_pread, _fd_pwrite, _fd_read, _fd_seek, _fd_write ];
...
var ASM_CONSTS = {
  590848: () => {
    ...
    const mobilePattern = new RegExp("Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini", "i");
  ...
  592266: () => {
    ...
    if (!blurred && state.blurPendingAt) {
      ...
      const inputStillFocused = state.input && document.activeElement == state.input;
    ...
    if (!input) {
      ...
      input.addEventListener("blur", function() {
        if (state.closingByApp) {
          ...
          state.blurPendingAt = (typeof performance != "undefined") ? performance.now() : Date.now();
          setTimeout(function() {
  ...
  597506: () => Module["SDL3"].audioContext.sampleRate,
  597557: ($0, $1, $2, $3) => {
    var SDL3 = Module["SDL3"];
  ...
  602912: () => (navigator.mediaDevices === undefined) ? 0 : 1,
  602971: ($0, $1, $2, $3, $4) => {
    const device = $0;
    const w = $1;
    const h = $2;
  ...
  610895: () => Module["SDL3"]["mouse_x"],
  610933: () => Module["SDL3"]["mouse_y"],
  610971: $0 => Module["SDL3"]["mouse_buttons"][$0],
  611019: $0 => {
    var data = $0;
    ...
    if (SDL3.makePointerEventCStruct === undefined) {
      SDL3.makePointerEventCStruct = function(left, top, event) {
        ...
        if (ptr != 0) {
          ...
          (growMemViews(), HEAP32)[idx++] = ptrtype;
          ...
          (growMemViews(), HEAP32)[idx++] = (event.type == "pointerdown") ? 1 : 0;
          (growMemViews(), HEAPF32)[idx++] = event.movementX;
          (growMemViews(), HEAPF32)[idx++] = event.movementY;
          (growMemViews(), HEAPF32)[idx++] = event.clientX - left;
          (growMemViews(), HEAPF32)[idx++] = event.clientY - top;
          if (ptrtype == 3) {
  ...
  613390: () => document.body.clientWidth,
  613428: () => document.body.clientHeight,
  613467: () => window.innerWidth,
  613497: () => window.innerHeight,
  613528: () => window.outerWidth,
  613558: () => window.outerHeight,
  613589: () => window.pageXOffset,
  613620: () => window.pageYOffset,
  613651: ($0, $1) => {
  ...
  619432: () => window.innerWidth,
  619462: () => window.innerHeight,
  619493: $0 => {
  ...
  620169: () => window.innerWidth,
  620199: () => window.innerHeight,
  620230: $0 => {
...
function js_fetch_cancel(slotIndex, requestId) {
...
function js_fetch_start(url, slotIndex, requestId, resumeOffset) {
  ...
  var doFetch = async function() {
    try {
      var response = await fetch(urlStr, {
        headers,
      ...
      while (true) {
        ...
        Module._on_fetch_progress(slotIndex, receivedLength, total);
        var offset = 0;
        while (offset < value.length) {
          var chunkSize = Math.min(value.length - offset, SCRATCH_SIZE);
          var ptr = Module._c_get_fetch_chunk_buffer(slotIndex, chunkSize);
          if (!ptr) {
            console.error("Fetch buffer overflow!");
            Module._on_fetch_error(slotIndex, -1);
            return;
          }
          var chunkView = value.subarray(offset, offset + chunkSize);
...
function web_persist_sync_impl() {
...
function web_storage_size(key_ptr) {
...
function web_storage_load(key_ptr, dst, size) {
  const key = UTF8ToString(key_ptr);
  try {
    const value = globalThis.localStorage.getItem(key);
    if (value == null) {
    ...
    for (let i = 0; i < size; ++i) {
      (growMemViews(), HEAPU8)[dst + i] = value.charCodeAt(i) & 255;
    }
    return 1;
  } catch (e) {
...
function web_storage_save(key_ptr, src, size) {
  const key = UTF8ToString(key_ptr);
  try {
    ...
    for (let i = 0; i < size; i += chunk_size) {
      ...
      value += String.fromCharCode.apply(null, (growMemViews(), HEAPU8).subarray(src + i, src + end));
    }
...
function init_browser_back_handler() {
  history.pushState({
    page: "sdl_app"
  }, "", "");
...
var _malloc, _get_fetch_chunk_buffer, _on_fetch_progress, _on_fetch_chunk, _on_fetch_restart_file, _on_fetch_complete, _on_fetch_error, _on_fetch_cancelled, _SDL_free, _free, _mobile_text_input_web_wakeup, _main, _on_browser_back_pressed, _SDL_malloc, _SDL_calloc, _SDL_realloc, _Emscripten_force_free, _CallSDLEmscriptenMainFunction, _SDLEmscriptenCameraPermissionOutcome, _SDLEmscriptenThreadIterate, _Emscripten_HandlePointerEnter, _Emscripten_HandlePointerLeave, _Emscripten_HandlePointerGeneric, _Emscripten_HandleMouseButtonUpGlobal, _Emscripten_SendDragEvent, _Emscripten_SendDragCompleteEvent, _Emscripten_SendDragTextEvent, _Emscripten_SendDragFileEvent, _Emscripten_HandleLockKeysCheck, _Emscripten_SendSystemThemeChangedEvent, _requestFullscreenThroughSDL, _pthread_self, __emscripten_tls_init, _emscripten_builtin_memalign, __emscripten_run_callback_on_thread, __emscripten_thread_init, __emscripten_thread_crashed, __emscripten_run_js_on_main_thread_done, __emscripten_run_js_on_main_thread, __emscripten_thread_free_data, __emscripten_thread_exit, __emscripten_check_mailbox, _setThrew, _emscripten_stack_set_limits, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, __indirect_function_table, wasmTable;

function assignWasmExports(wasmExports) {
  _malloc = wasmExports["malloc"];
  _get_fetch_chunk_buffer = Module["_get_fetch_chunk_buffer"] = wasmExports["get_fetch_chunk_buffer"];
  _on_fetch_progress = Module["_on_fetch_progress"] = wasmExports["on_fetch_progress"];
  _on_fetch_chunk = Module["_on_fetch_chunk"] = wasmExports["on_fetch_chunk"];
  _on_fetch_restart_file = Module["_on_fetch_restart_file"] = wasmExports["on_fetch_restart_file"];
  _on_fetch_complete = Module["_on_fetch_complete"] = wasmExports["on_fetch_complete"];
  _on_fetch_error = Module["_on_fetch_error"] = wasmExports["on_fetch_error"];
  _on_fetch_cancelled = Module["_on_fetch_cancelled"] = wasmExports["on_fetch_cancelled"];
  ...
  _on_browser_back_pressed = Module["_on_browser_back_pressed"] = wasmExports["on_browser_back_pressed"];
...
function assignWasmImports() {
  wasmImports = {
    ...
    /** @export */ init_browser_back_handler,
    /** @export */ invoke_iii,
    /** @export */ invoke_iiii,
    /** @export */ invoke_iiiii,
    /** @export */ invoke_v,
    ...
    /** @export */ js_fetch_cancel,
    /** @export */ js_fetch_start,
    /** @export */ memory: wasmMemory,
    /** @export */ proc_exit: _proc_exit,
    /** @export */ uuid_generate: _uuid_generate,
    /** @export */ web_persist_sync_impl,
    /** @export */ web_storage_load,
    /** @export */ web_storage_save,
    /** @export */ web_storage_size
  };
}
